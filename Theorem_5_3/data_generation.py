...
class simData(object):
    def __init__(self, N, d):
        """
        generate simulated data with a causal model described in Theorem 5.4
        """
        np.random.seed(42)
